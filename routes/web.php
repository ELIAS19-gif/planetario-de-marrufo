...
//Route::post('/venta/save',[CoffeshopController::class, 'guardar_orden'])->name('guardar_orden');
...
Route::get('/dashboard/demogratafico/genero', [DashboardController::class, 'demografico_genero']);
